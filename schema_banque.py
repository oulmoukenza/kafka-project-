...
KAFKA_TOPIC = "topicstock"
SCHEMA = StructType([
    StructField("timestamp", StringType()),
    StructField("bnp", FloatType()),
    StructField("societeG", FloatType()),
    StructField("goldman", FloatType()),
    StructField("hsbc", FloatType()),
    StructField("jpmorgan", FloatType()),
    StructField("bitcoin_price_usd", FloatType())
])
